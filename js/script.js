(function () {
  ...
  const CONTACT_RECIPIENT = "gabrielwork0815@gmail.com";
  ...
  function flushPendingSeek() {
    ...
    if (Math.abs(pendingVideoTime - activeVideoTime) < VIDEO_SEEK_EPSILON)
      return;
  ...
  function setContactStatus(text, isError) {
    ...
    contactStatus.style.color = isError ? "#E64833" : "#FBE9D0";
  }
  ...
  function bindContactForm() {
    ...
    contactForm.addEventListener("submit", async (event) => {
      ...
      try {
        ...
        setContactStatus(
          "Could not send right now. Please email gabrielwork0815@gmail.com directly.",
          true,
        );
      } finally {
        if (submitButton) {
